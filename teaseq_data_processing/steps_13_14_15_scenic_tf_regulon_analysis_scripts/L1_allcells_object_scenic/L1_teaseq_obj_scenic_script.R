# SCENIC analysis for Level 1 TEAseq object - all mononuclear cells in tonsil and peripheral blood samples
...
setwd('/filepath/step13_bulk_harmony/SCENIC/')
...
tss.10kb.feather <- read_feather("/filepath/step13_bulk_harmony/SCENIC/hg38_10kbp_up_10kbp_down_full_tx_v10_clust.genes_vs_motifs.rankings.feather")
...
write_feather(tss.10kb.feather, "/filepath/step13_bulk_harmony/SCENIC/modified_hg38_10kb_up_down.feather")
...
tss.500bp.100bp.feather <- read_feather("/filepath/step13_bulk_harmony/SCENIC/hg38_500bp_up_100bp_down_full_tx_v10_clust.genes_vs_motifs.rankings.feather")
...
write_feather(tss.500bp.100bp.feather, "/filepath/step13_bulk_harmony/SCENIC/modified_hg38_500bp_up_100bp_down.feather")
...
scenicOptions <- initializeScenic(
  org = "hgnc",
  dbDir = "/filepath/step13_bulk_harmony/SCENIC",
  dbs = c(
...
l1_teaseq_obj <- JoinLayers(l1_teaseq_obj, assay = 'RNA') # required to join RNA layers
Idents(l1_teaseq_obj) <- 'l1_wnn_annot' # Level 1 analysis bulk cell type annotations
exprMat <- l1_teaseq_obj@assays$RNA$counts
cellInfo <- l1_teaseq_obj@meta.data['l1_wnn_annot']
...
saveRDS(scenicOptions, '/filepath/step13_bulk_harmony/SCENIC/scenicOptions_post_Genie3.rds')
saveRDS(exprMat_filtered_log, '/filepath/step13_bulk_harmony/SCENIC/exprMat_filtered_log_post_Genie3.rds')
saveRDS(exprMat_filtered, '/filepath/step13_bulk_harmony/SCENIC/exprMat_filtered_post_Genie3.rds')
saveRDS(exprMat, '/filepath/step13_bulk_harmony/SCENIC/exprMat_post_Genie3.rds')
saveRDS(genesKept, '/filepath/step13_bulk_harmony/SCENIC/genesKept_post_Genie3.rds')
saveRDS(cellInfo, '/filepath/step13_bulk_harmony/SCENIC/cellInfo_post_Genie3.rds')
...
saveRDS(scenicOptions, '/filepath/step13_bulk_harmony/SCENIC/scenicOptions1.rds')

print('Running SCENIC Step 2 - Creating Regulons')
scenicOptions <- runSCENIC_2_createRegulons(scenicOptions, coexMethod= NULL) 
saveRDS(scenicOptions, '/filepath/step13_bulk_harmony/SCENIC/scenicOptions2.rds')

print('Running SCENIC Step 3 - Score Cells')
scenicOptions <- runSCENIC_3_scoreCells(scenicOptions, exprMat_log)
saveRDS(scenicOptions, '/filepath/step13_bulk_harmony/SCENIC/scenicOptions3.rds')
...
saveRDS(scenicOptions, '/filepath/step13_bulk_harmony/SCENIC/scenicOptions4.rds')
