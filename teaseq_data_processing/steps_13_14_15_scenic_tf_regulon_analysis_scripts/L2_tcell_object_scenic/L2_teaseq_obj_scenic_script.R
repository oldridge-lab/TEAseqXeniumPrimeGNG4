# SCENIC analysis for Level 2 TEAseq T cell object
...
setwd('/filepath/step14_l2_teaseq_tcell_analysis/SCENIC')
...
tss.10kb.feather <- read_feather("/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/hg38_10kbp_up_10kbp_down_full_tx_v10_clust.genes_vs_motifs.rankings.feather")
...
write_feather(tss.10kb.feather, "/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/modified_hg38_10kb_up_down.feather")
...
tss.500bp.100bp.feather <- read_feather("/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/hg38_500bp_up_100bp_down_full_tx_v10_clust.genes_vs_motifs.rankings.feather")
...
write_feather(tss.500bp.100bp.feather, "/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/modified_hg38_500bp_up_100bp_down.feather")
...
scenicOptions <- initializeScenic(
  org = "hgnc",
  dbDir = "/filepath/step14_l2_teaseq_tcell_analysis/SCENIC",
  dbs = c(
...
# 5) Get RNA counts and metadata from Seurat object ----
...
l2_teaseq_tcell_obj <- JoinLayers(l2_teaseq_tcell_obj, assay = 'RNA') # Required to join RNA layers
Idents(l2_teaseq_tcell_obj) <- 'l2_tcell_wnn_annot' # Level 2 analysis cell type annotations
exprMat <- l2_teaseq_tcell_obj@assays$RNA$counts
cellInfo <- l2_teaseq_tcell_obj@meta.data['l2_tcell_wnn_annot']
...
genesKept <- geneFiltering(exprMat, scenicOptions=scenicOptions, minCountsPerGene=3*.01*ncol(exprMat), minSamples=ncol(exprMat)*.01) # default filtering
...
saveRDS(scenicOptions, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/scenicOptions_post_Genie3.rds')
saveRDS(exprMat_filtered_log, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/exprMat_filtered_log_post_Genie3.rds')
saveRDS(exprMat_filtered, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/exprMat_filtered_post_Genie3.rds')
saveRDS(exprMat, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/exprMat_post_Genie3.rds')
saveRDS(genesKept, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/genesKept_post_Genie3.rds')
saveRDS(cellInfo, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/cellInfo_post_Genie3.rds')
...
saveRDS(scenicOptions, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/scenicOptions1.rds')

print('Running SCENIC Step 2 - Creating Regulons')
scenicOptions <- runSCENIC_2_createRegulons(scenicOptions, coexMethod= NULL) 
saveRDS(scenicOptions, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/scenicOptions2.rds')

print('Running SCENIC Step 3 - Score Cells')
scenicOptions <- runSCENIC_3_scoreCells(scenicOptions, exprMat_log)
saveRDS(scenicOptions, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/scenicOptions3.rds')
...
saveRDS(scenicOptions, '/filepath/step14_l2_teaseq_tcell_analysis/SCENIC/scenicOptions4.rds')
