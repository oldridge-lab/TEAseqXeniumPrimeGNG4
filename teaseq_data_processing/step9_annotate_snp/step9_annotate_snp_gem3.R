# Step 9 - Annotate SNP Profile (GEM3) ----
...
gem3.singlet <- readRDS("/filepath/step8_filter_multiplets/gem3.singlet.umi.rds")

# 3) Visualize signal for each unique HTO across SNP profiles ----

# Set idents to SNP-based souporcell profiles
Idents(gem3.singlet) <- "snp.profile"

# CLR-normalize HTO counts across cells
DefaultAssay(gem3.singlet) <- "HTO"
gem3.singlet <- NormalizeData(gem3.singlet, assay= "HTO", normalization.method = "CLR", margin = 2)

# Plot HTO counts for each SNP profile
VlnPlot(gem3.singlet, features = c("HTO-1","HTO-2","HTO-3","HTO-4","HTO-5","HTO-6","HTO-7","HTO-8","HTO-9","HTO-10","HTO-11","HTO-12","HTO-13","HTO-14","HTO-15","HTO-16"), 
...
gem3.singlet$snp.donor <- gem3.singlet$snp.profile
Idents(gem3.singlet) <- "snp.donor"
gem3.annot <- RenameIdents(gem3.singlet,
                           "1" = "P1",
                           "4" = "P2",
                           "2" = "P3",
                           "5" = "P4",
                           ...
                           "6" = "T3",
                           "7" = "T4")
gem3.annot$snp.donor <- Idents(gem3.annot)

# Plot HTO counts for each annotated SNP donor
VlnPlot(gem3.annot, features = c("HTO-1","HTO-2","HTO-3","HTO-4","HTO-5","HTO-6","HTO-7","HTO-8","HTO-9","HTO-10","HTO-11","HTO-12","HTO-13","HTO-14","HTO-15","HTO-16"), 
...
Idents(gem3.annot) <- "snp.donor"
gem3.annot$snp.tissue <- gem3.annot$snp.donor
Idents(gem3.annot) <- "snp.tissue"
gem3.annot <- RenameIdents(gem3.annot, 
                            "P1" = "PBMC",
                            "P2" = "PBMC",
                            "P3" = "PBMC",
                            "P4" = "PBMC",
                            ...
                            "T3" = "Tonsil",
                            "T4" = "Tonsil")
gem3.annot$snp.tissue <- Idents(gem3.annot)
...
hto_df <- t(as.data.frame(GetAssayData(subset(gem3.annot), assay = "HTO")))
snp <- as.data.frame(gem3.annot$snp.donor)
...
saveRDS(gem3.annot, "/filepath/step9_annotate_snp/gem3.annot.snp.rds")
