# Step 9 - Annotate SNP Profile (GEM8) ----
...
gem8.singlet <- readRDS("/filepath/step8_filter_multiplets/gem8.singlet.umi.rds")

# 3) Visualize signal for each unique HTO across SNP profiles ----

# Set idents to SNP-based souporcell profiles
Idents(gem8.singlet) <- "snp.profile"

# CLR-normalize HTO counts across cells
DefaultAssay(gem8.singlet) <- "HTO"
gem8.singlet <- NormalizeData(gem8.singlet, assay= "HTO", normalization.method = "CLR", margin = 2)

# Plot HTO counts for each SNP profile
VlnPlot(gem8.singlet, features = c("HTO-1","HTO-2","HTO-3","HTO-4","HTO-5","HTO-6","HTO-7","HTO-8","HTO-9","HTO-10","HTO-11","HTO-12","HTO-13","HTO-14","HTO-15","HTO-16"), 
...
gem8.singlet$snp.donor <- gem8.singlet$snp.profile
Idents(gem8.singlet) <- "snp.donor"
gem8.annot <- RenameIdents(gem8.singlet,
                           "1" = "P1",
                           "0" = "P2",
                           "5" = "P3",
                           "3" = "P4",
                           ...
                           "7" = "T3",
                           "2" = "T4")
gem8.annot$snp.donor <- Idents(gem8.annot)

# Plot HTO counts for each annotated SNP donor
VlnPlot(gem8.annot, features = c("HTO-1","HTO-2","HTO-3","HTO-4","HTO-5","HTO-6","HTO-7","HTO-8","HTO-9","HTO-10","HTO-11","HTO-12","HTO-13","HTO-14","HTO-15","HTO-16"), 
...
Idents(gem8.annot) <- "snp.donor"
gem8.annot$snp.tissue <- gem8.annot$snp.donor
Idents(gem8.annot) <- "snp.tissue"
gem8.annot <- RenameIdents(gem8.annot, 
                            "P1" = "PBMC",
                            "P2" = "PBMC",
                            "P3" = "PBMC",
                            "P4" = "PBMC",
                            ...
                            "T3" = "Tonsil",
                            "T4" = "Tonsil")
gem8.annot$snp.tissue <- Idents(gem8.annot)
...
hto_df <- t(as.data.frame(GetAssayData(subset(gem8.annot), assay = "HTO")))
snp <- as.data.frame(gem8.annot$snp.donor)
...
saveRDS(gem8.annot, "/filepath/step9_annotate_snp/gem8.annot.snp.rds")
