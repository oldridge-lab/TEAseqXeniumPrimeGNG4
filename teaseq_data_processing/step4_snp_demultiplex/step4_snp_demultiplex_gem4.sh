...
#SBATCH --job-name=snp_demux_gem4       # Job name
#SBATCH --output=snp_demux_gem4         # Output file
#SBATCH --error=snp_demux_gem4_error    # Error file
...
BARCODES="/filepath/step4_snp_demultiplex/gem_barcodes/gem4/barcodes.tsv"
          
# Provide path to binary alignment map file for selected GEM well 
BAM="/filepath/cellranger_arc_output/GEM4_ARC/outs/gex_possorted_bam.bam"
