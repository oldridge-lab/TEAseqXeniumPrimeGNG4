...
#SBATCH --job-name=snp_demux_gem3       # Job name
#SBATCH --output=snp_demux_gem3         # Output file
#SBATCH --error=snp_demux_gem3_error    # Error file
...
BARCODES="/filepath/step4_snp_demultiplex/gem_barcodes/gem3/barcodes.tsv"
          
# Provide path to binary alignment map file for selected GEM well 
BAM="/filepath/cellranger_arc_output/GEM3_ARC/outs/gex_possorted_bam.bam"
