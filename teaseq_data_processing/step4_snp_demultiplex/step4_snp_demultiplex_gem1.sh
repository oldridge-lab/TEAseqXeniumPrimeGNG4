...
#SBATCH --job-name=snp_demux_gem1       # Job name
#SBATCH --output=snp_demux_gem1         # Output file
#SBATCH --error=snp_demux_gem1_error    # Error file
...
BARCODES="/filepath/step4_snp_demultiplex/gem_barcodes/gem1/barcodes.tsv"
          
# Provide path to binary alignment map file for selected GEM well 
BAM="/filepath/cellranger_arc_output/GEM1_ARC/outs/gex_possorted_bam.bam"
