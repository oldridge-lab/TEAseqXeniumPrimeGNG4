...
#SBATCH --job-name=snp_demux_gem8       # Job name
#SBATCH --output=snp_demux_gem8         # Output file
#SBATCH --error=snp_demux_gem8_error    # Error file
...
BARCODES="/filepath/step4_snp_demultiplex/gem_barcodes/gem8/barcodes.tsv"
          
# Provide path to binary alignment map file for selected GEM well 
BAM="/filepath/cellranger_arc_output/GEM8_ARC/outs/gex_possorted_bam.bam"
