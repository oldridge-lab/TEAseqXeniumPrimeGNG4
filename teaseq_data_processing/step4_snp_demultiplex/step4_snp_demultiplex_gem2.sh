...
#SBATCH --job-name=snp_demux_gem2       # Job name
#SBATCH --output=snp_demux_gem2         # Output file
#SBATCH --error=snp_demux_gem2_error    # Error file
...
BARCODES="/filepath/step4_snp_demultiplex/gem_barcodes/gem2/barcodes.tsv"
          
# Provide path to binary alignment map file for selected GEM well 
BAM="/filepath/cellranger_arc_output/GEM2_ARC/outs/gex_possorted_bam.bam"
