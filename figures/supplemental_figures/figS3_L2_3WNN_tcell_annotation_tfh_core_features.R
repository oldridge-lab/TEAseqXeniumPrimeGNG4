...
DefaultAssay(l2_teaseq_tcell_obj) <- 'RNA'
pdf('/filepath/fig1/fig1_supp/tfh_feature_umap/tcell_il21_rna_umap.pdf', width = 6, height = 6)
...
DefaultAssay(l2_teaseq_tcell_obj) <- 'RNA'
pdf('/filepath/fig1/fig1_supp/tfh_feature_umap/tcell_il10_rna_umap.pdf', width = 6, height = 6)
do_FeaturePlot(l2_teaseq_tcell_obj, reduction = 'umap.wnn.harmony', features = 'IL10', use_viridis = FALSE, sequential.palette = "Oranges", order = TRUE, legend.position = 'right', legend.length = 11, border.size = 1.25, pt.size = 1) + coord_fixed() + NoAxes() + ggtitle(NULL)
dev.off()
...
DefaultAssay(l2_teaseq_tcell_obj) <- 'ADT'
pdf('/filepath/fig1/fig1_supp/tfh_feature_umap/tcell_psgl1_adt_umap.pdf', width = 6, height = 6)
do_FeaturePlot(l2_teaseq_tcell_obj, reduction = 'umap.wnn.harmony', features = 'adt-CD162', use_viridis = FALSE, sequential.palette = "Oranges", order = TRUE, legend.position = 'right', legend.length = 11, border.size = 1.25, pt.size = 1) + coord_fixed() + NoAxes() + ggtitle(NULL)
dev.off()

# E) L2 T Cell 3WNN Cluster Marker DotPlot - ATAC ----
...
# Assemble ATAC (GeneActivity) annotation dotplot
...
# F) L2 T Cell 3WNN Cluster Marker DotPlot - RNA ----
DefaultAssay(l2_teaseq_tcell_obj) <- 'RNA'
...
# G) L2 T Cell 3WNN Cluster Marker DotPlot - ADT ----
DefaultAssay(l2_teaseq_tcell_obj) <- 'ADT'
...
# H) Identifying shared gene expression features of all 3WNN L2 Tfh states relative to nonTfh group ----

# UMAP embedding of L2 Tfh-like clusters vs grouped nonTfh clusters ----
...
# Identifying core ATAC features enriched across L2 Tfh-like clusters versus grouped nonTfh clusters ----
...
# Identifying core RNA features enriched across L2 Tfh-like clusters versus grouped nonTfh clusters ----
...
# Finding core multimodal ATAC and RNA features enriched across L2 Tfh-like clusters versus grouped nonTfh clusters ----
