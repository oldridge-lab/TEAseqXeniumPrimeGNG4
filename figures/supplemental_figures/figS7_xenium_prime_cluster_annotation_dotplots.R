...
# Code and data visualization for Fig. S7 (related to Fig. 4)
# Fig. S7 - Whole slide image coregistration and annotation of single-cell transcriptional clusters in tonsil Xenium Prime dataset, related to Figure 4
...
# Fig. S7A-7C - H&E, DAPI, and GNG4 spatial gene expression plots

# Images exported from Xenium Explorer (3.2.0)

# Fig. S7D - Xenium Prime L1 cluster annotation dotplot ----
...
# Fig. S7E - Xenium Prime L2 nnCD4 T cell subcluster annotation dotplot ----
