...
#SBATCH --job-name=tc654b_preprocess_script   # Job name
#SBATCH --output=log/tc654b_preproc_log.txt   # Log file
#SBATCH --error=log/tc654b_preproc_status.txt # Function status, warnings, and errors 
