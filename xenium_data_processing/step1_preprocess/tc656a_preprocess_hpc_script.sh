...
#SBATCH --job-name=tc656a_preprocess_script   # Job name
#SBATCH --output=log/tc656a_preproc_log.txt   # Log file
#SBATCH --error=log/tc656a_preproc_status.txt # Function status, warnings, and errors 
