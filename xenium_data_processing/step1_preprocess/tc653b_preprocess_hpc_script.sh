...
#SBATCH --job-name=tc653b_preprocess_script   # Job name
#SBATCH --output=log/tc653b_preproc_log.txt   # Log file
#SBATCH --error=log/tc653b_preproc_status.txt # Function status, warnings, and errors 
