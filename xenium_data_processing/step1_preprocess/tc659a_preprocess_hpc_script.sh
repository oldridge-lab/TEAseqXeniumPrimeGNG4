...
#SBATCH --job-name=tc659a_preprocess_script   # Job name
#SBATCH --output=log/tc659a_preproc_log.txt   # Log file
#SBATCH --error=log/tc659a_preproc_status.txt # Function status, warnings, and errors 
