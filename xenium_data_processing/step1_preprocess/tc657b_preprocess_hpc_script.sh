...
#SBATCH --job-name=tc657b_preprocess_script   # Job name
#SBATCH --output=log/tc657b_preproc_log.txt   # Log file
#SBATCH --error=log/tc657b_preproc_status.txt # Function status, warnings, and errors 
