...
#SBATCH --job-name=tc661b_qc                  # Job name
#SBATCH --output=log/tc661b_qc_log.txt        # Log file
#SBATCH --error=log/tc661b_qc_status.txt      # Function status, warnings, and errors 
