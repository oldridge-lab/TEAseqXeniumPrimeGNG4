...
#SBATCH --job-name=tc659a_qc                  # Job name
#SBATCH --output=log/tc659a_qc_log.txt        # Log file
#SBATCH --error=log/tc659a_qc_status.txt      # Function status, warnings, and errors 
