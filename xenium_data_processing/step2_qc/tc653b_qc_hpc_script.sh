...
#SBATCH --job-name=tc653b_qc                  # Job name
#SBATCH --output=log/tc653b_qc_log.txt        # Log file
#SBATCH --error=log/tc653b_qc_status.txt      # Function status, warnings, and errors 
