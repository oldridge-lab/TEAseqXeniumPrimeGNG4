...
#SBATCH --job-name=tc657b_qc                  # Job name
#SBATCH --output=log/tc657b_qc_log.txt        # Log file
#SBATCH --error=log/tc657b_qc_status.txt      # Function status, warnings, and errors 
