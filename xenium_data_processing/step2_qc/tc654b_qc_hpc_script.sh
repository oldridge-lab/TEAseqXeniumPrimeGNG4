...
#SBATCH --job-name=tc654b_qc                  # Job name
#SBATCH --output=log/tc654b_qc_log.txt        # Log file
#SBATCH --error=log/tc654b_qc_status.txt      # Function status, warnings, and errors 
